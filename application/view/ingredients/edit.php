<div class="menu-container">
        ...
        <div class="add-edit" id="add-edit">
                <form action="<?php echo URL; ?>ingredients/updateingredient" method="POST" enctype="multipart/form-data">
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3  col-lg-3 input-item">
                                ...
                                <div>
                                    <input type='hidden' name='imageFileId' value='<?php echo $ingredient->imageFileId ?>'/>
                                    <img src="<?php if($ingredient->imageFileName == "") {$filename = "no-image.png";} else {$filename = $ingredient->imageFileName;} echo URL . "img/" . $filename; ?>" class="menu-thumbnail"/>
