<div class="menu-container">
        <div class="list-header">
            <div class="title"><i class="fas fa-clipboard-list display-icon"></i>Kitchen Order List</div>
                    ...
                    <td class="col-lg-2">
                        <?php
                          if($order->status == OrderStatus::pending){
                            echo '<button class="btn-primary btn-block btn-order-action" data-action="'. OrderStatus::processing .'"  data-id="'. $order->id .'"><i class="fa fa-circle-notch"></i> Process</button>';
                          }
                          else if($order->status == OrderStatus::processing){
                            echo '<button class="btn-success btn-block btn-order-action" data-action="'. OrderStatus::forServing .'"  data-id="'. $order->id .'"><i class="fa fa-check"></i> Ready For Serving</button>';
                          }
                        ?>
                    </td>
                </tr>
