...
<div class="menu-container">
        ...
        <div class="title"><i class="fas fa-shopping-bag display-icon"></i>Daily Sales Report</div>
        ...
        <div class="filters" id="filters">
            ...
            <form action="<?php echo URL; ?>reports/dailySalesReport" method="POST">
                <div class="container">
                    <div class="row">
        ...
        <table class="reports">
            ...
            <?php 
                ...
                foreach ($sales as $sale) { 
                    ...
                    $newData = array("y" => $sale->priceTotal, "label" => $sale->menuName);
