...
<div class="menu-container">
        ...
        <div class="title"><i class="fas fa-shopping-bag display-icon"></i>Monthly Sales Report</div>
        ...
        <div class="filters" id="filters">
            ...
            <form action="<?php echo URL; ?>reports/monthlySalesReport" method="POST">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 filter-row" >
                            <label class="report-filter">Start Date</label><input  class="report-filter" name="startDate" type="date" value="<?php echo $_SESSION['startDate']; ?>" required/>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4  col-lg-4 filter-row">
        ...
        <table class="reports">
            ...
            <?php 
                ...
                foreach ($sales as $sale) {
                    ...
                    $weeklyTotal = $weeklyTotal + $sale->priceTotal;
                    
                    if ($sale->weekOrdered != $week){
                        echo('<tr class=" heading"><td class="dayOfWeek"> Week &nbsp;'.$sale->weekOrdered.'</td><td colspan="5"></td></tr>');
                        $week = $sale->weekOrdered;
                        $newData = array("y" => $weeklyTotal, "label" => "Week ".$week);
...
<script>
    ...
    var chart = new CanvasJS.Chart("chartContainer", {
        title: {
            text: <?php echo '"Sales Over the Month of '.$month.'"'; ?>
        },
        axisY: {
            title: "Amount"
        },
