<div class="menu-container">
        <div class="list-header">    
            <div class="title"><i class="fas fa-hockey-puck display-icon"></i>Add Table</div>
        </div>
        <div class="add-edit" id="add-edit">
                <form action="<?php echo URL; ?>tables/submitTable" method="POST">
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 input-item input-button">
                                <button class="primary-button" type="submit" name="submit_add_table" ><i class="fas fa-check display-icon"></i>Submit</button>
                            </div>
                        </div>
                    </div>
